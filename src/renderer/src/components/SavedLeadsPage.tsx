...
function SavedLeadsPage(): JSX.Element {
  ...
  return (
    <div className="scout-page saved-leads-page">
          ...
          {whatsAppBulkVerifying ? (
            ...
            <button
              ...
              style={{
                ...
                background: whatsAppReady ? 'rgba(37, 211, 102, 0.12)' : 'rgba(15, 23, 42, 0.6)',
                color: whatsAppReady ? '#25d366' : '#94a3b8',
                fontSize: '0.85rem',
                fontWeight: 500,
                cursor: !whatsAppReady || unverifiedWhatsAppCount === 0 ? 'not-allowed' : 'pointer',
      ...
      {/* Empty */}
      {!isLoading && leads.length === 0 && facebookLeads.length === 0 && (
        <div
          style={{
            display: 'flex',
            flexDirection: 'column',
        ...
        >
          ...
          <p style={{ color: '#64748b' }}>
            Save leads from Maps Scout or Facebook Page Scraper to see them here.
          </p>
        </div>
      )}
      ...
      {!isLoading && allLeads.length > 0 && (
        ...
        >
          {allLeads.map((rawLead) => {
            if (rawLead.leadType === 'facebook') {
              const lead = rawLead as SavedFacebookLead
              return (
                <div
                  key={lead.id}
                  style={{
            ...
            const lead = rawLead as SavedMapsLead
            return (
              <div
                key={lead.id}
                style={{
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', gap: '0.5rem' }}>
                        ...
                        <button
                          ...
                          disabled={generatingEmailPitchIds.has(lead.id) || !selectedMailCampaignId}
                          style={{
                            padding: '0.4rem 0.75rem',
                            borderRadius: '8px',
                            border: 'none',
      ...
      {!isLoading && (leads.length > 0 || facebookLeads.length > 0) && allLeads.length === 0 && (
        <div
          style={{
            display: 'flex',
            flexDirection: 'column',
